...
FirstPass = True
id1 = "mail@edu.esiee.fr"
id2 = "mot de passe"

try:
    file = open("log.txt", 'r')
    id1 = str(file.readline())
    id2 = str(file.readline())
    file.close()
    mdp = id2
    identifiant = id1
except:
...
recordid1 = StringVar()
recordid1.set(id1)
txt1 = Entry(window, width=30, textvariable=recordid1)
...
recordid = StringVar()
recordid.set(id2)
txt2 = Entry(window, width=30, textvariable=recordid)
